    ...
    <html>
      ...
      <body style="text-align:center;">
        ...
        <table style="width:75%; margin-left:auto; margin-right:auto; text-align:center;">
          ...
          <tr>
            <td style="width:50%;">
              <xsl:value-of select="/movieRental/header/statistics/numberOfMovies"/>
            </td>
            <td style="width:50%;">
              <xsl:value-of select="/movieRental/header/statistics/numberOfClients"/>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2">
              <xsl:value-of select="/movieRental/header/statistics/numberOfDramas"/>
            </td>
          </tr>
        </table>
                ...
                <ul>
                  <xsl:for-each select="borrows/borrow">
                    <li>
                      ...
                      <p>
                        <xsl:text>Wypożyczone od </xsl:text>
